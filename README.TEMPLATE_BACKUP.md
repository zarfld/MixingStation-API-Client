...
**Phase 1 (Epic 1) Vertical Slice**: Connect → Read → Normalize → Export
...
├── src/
│   └── MixingStation.Client/         # Class library (.NET 8)
│       ├── App/                      # /app/* REST endpoints
│       ├── Console/                  # /console/* REST endpoints
│       ├── Models/                   # DTOs + CanonicalModel
│       ├── Normalization/            # API → CanonicalModel transform
│       ├── Export/                   # Excel export logic
│       └── Exceptions/               # Exception hierarchy
├── examples/
│   └── exportlists/                  # CLI tool (.NET 8)
├── tests/
│   └── MixingStation.Client.Tests/   # xUnit tests
├── 01-stakeholder-requirements/      # Business context
├── 02-requirements/                  # Functional/non-functional requirements
├── 03-architecture/                  # Architecture decisions, C4 diagrams
├── 04-design/                        # Detailed design specifications
│   └── phase-1-detailed-design.md   # Phase 1 vertical slice design
└── 05-implementation/                # Implementation status
